...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/declaracao-conteudo', icon: FileStack, label: 'Declaração de Conteúdo' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/financeiro-avancado', icon: TrendingUp, label: 'Financeiro Avançado', pro: true },
